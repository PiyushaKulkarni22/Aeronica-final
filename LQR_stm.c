...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Drone LQR Controller — STM32F446RE
...
static const float K_data[CTRL_DIM * STATE_DIM] = {
     5.0f, 0.0f, 0.0f, 0.80f, 0.0f,  0.0f,
     0.0f, 5.0f, 0.0f, 0.0f,  0.80f, 0.0f,
     0.0f, 0.0f, 3.5f, 0.0f,  0.0f,  0.60f
};
static Matrix K;
...
int main(void)
{
  ...
  HAL_Delay(2000);
  mat_set(&K, CTRL_DIM, STATE_DIM, K_data);
